...
def get_stats(db_path: Optional[str] = None):
...
def get_performance_by_type(snapshot_hours: int = 24, db_path: Optional[str] = None):
...
def get_top_posts(limit: int = 10, db_path: Optional[str] = None):
...
def get_hourly_performance(db_path: Optional[str] = None):
...
def get_daily_performance(db_path: Optional[str] = None):
